...
<body>
  ...
  <!-- barra filtrar -->
  <div>
    <form action="controlador/controladorFiltrarProfesores.php" method="GET" style="margin-top: 10px;">
      ...
      foreach ($datos as $fila) { ?>
        <tr>
          <tbody>
            ...
            <td><?php echo $fila['ApellidoProfesor'] ?></td>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="controlador/controladorEditarProfesores.php" method="POST">
                      <?php
